...
SET @@GLOBAL.GTID_PURGED=/*!80000 '+'*/ '83a29080-b2ce-11f0-b9bf-2bd4a7c7f163:1-1391';
...
INSERT INTO `event_seat_grades` VALUES (1,1,1,1,1,'2026-01-17 09:12:04'),(2,1,2,1,2,'2026-01-17 09:12:04');
...
--
-- Table structure for table `event_seat_prices`
--

DROP TABLE IF EXISTS `event_seat_prices`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `event_seat_prices` (
  ...
  `updated_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
  UNIQUE KEY `uk_event_grade_price` (`event_id`,`seat_grade_id`),
  KEY `seat_grade_id` (`seat_grade_id`),
  CONSTRAINT `event_seat_prices_ibfk_1` FOREIGN KEY (`event_id`) REFERENCES `events` (`id`) ON DELETE CASCADE,
  CONSTRAINT `event_seat_prices_ibfk_2` FOREIGN KEY (`seat_grade_id`) REFERENCES `seat_grades` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='공연별 좌석 정가';
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `event_seat_prices`
--

LOCK TABLES `event_seat_prices` WRITE;
/*!40000 ALTER TABLE `event_seat_prices` DISABLE KEYS */;
INSERT INTO `event_seat_prices` VALUES (1,1,1,150000,1,'2026-01-17 09:12:04','2026-01-17 09:12:04'),(2,1,2,110000,1,'2026-01-17 09:12:04','2026-01-17 09:12:04');
/*!40000 ALTER TABLE `event_seat_prices` ENABLE KEYS */;
UNLOCK TABLES;
...
) ENGINE=InnoDB AUTO_INCREMENT=151 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='Refresh Token 저장 테이블';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `ticket_features` (
  ...
  `icon` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '아이콘 (UI용)',
  `sort_order` int DEFAULT '0' COMMENT '정렬 순서',
  `created_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP,
  `updated_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
...
INSERT INTO `tickets` VALUES (1,7,1,NULL,1,'2026-01-28 19:00:00',NULL,NULL,'19열',2,0,2,220000,'VIP석 연석 2장',1,'2025-12-17 07:49:16','2026-01-16 05:56:47',NULL,1,1,1),(2,7,1,NULL,1,'2026-01-28 19:00:00',NULL,NULL,'3열',1,0,1,150000,'R석 1장',1,'2025-12-17 07:49:16','2026-01-16 05:56:47',NULL,1,1,1),(3,7,1,NULL,1,'2026-01-28 19:00:00',NULL,NULL,'20열',3,0,1,99000,'S석',1,'2025-12-17 07:49:16','2026-01-16 05:56:47',NULL,1,1,1),(4,7,1,NULL,1,'2026-01-29 19:00:00',NULL,NULL,'11열',2,0,0,230000,'VIP석 연석 2장 (매진임박)',1,'2025-12-17 07:49:16','2026-01-16 05:56:47',NULL,1,1,1),(5,7,1,NULL,1,'2026-01-29 19:00:00',NULL,NULL,'14열',4,0,2,160000,'R석',1,'2025-12-17 07:49:16','2026-01-16 05:56:47',NULL,1,1,1),(6,7,2,NULL,1,'2026-02-23 18:00:00',NULL,NULL,'15열',10,0,8,180000,'VIP 입장권',1,'2025-12-17 07:49:16','2026-01-16 05:56:47',NULL,1,1,1),(7,7,2,NULL,1,'2026-02-23 18:00:00',NULL,NULL,'14열',30,0,25,99000,'일반 입장권',1,'2025-12-17 07:49:16','2026-01-16 05:56:47',NULL,1,1,1),(8,7,2,NULL,1,'2026-02-24 18:00:00',NULL,NULL,'5열',20,0,12,99000,'일반 입장권',1,'2025-12-17 07:49:16','2026-01-16 05:56:47',NULL,1,1,1),(9,7,3,NULL,1,'2026-08-02 17:00:00',NULL,NULL,'4열',50,0,30,132000,'스탠딩 입장권',1,'2025-12-17 07:49:16','2026-01-16 05:56:47',NULL,1,1,1),(10,7,3,NULL,1,'2026-08-02 17:00:00',NULL,NULL,'2열',20,0,2,165000,'지정석 입장권 (인기)',1,'2025-12-17 07:49:16','2026-01-16 05:56:47',NULL,1,1,1),(11,7,3,NULL,1,'2026-08-03 17:00:00',NULL,NULL,'20열',50,0,50,132000,'스탠딩 입장권',1,'2025-12-17 07:49:16','2026-01-16 05:56:47',NULL,1,1,1),(12,7,4,NULL,1,'2026-03-14 18:00:00',NULL,NULL,'12열',10,0,5,250000,'VIP석 (티켓 5장 남음)',1,'2025-12-17 07:49:16','2026-01-16 05:56:47',NULL,1,1,1),(13,7,6,NULL,1,'2026-10-28 19:00:00',NULL,NULL,'1열',100,0,20,180000,'스탠딩 입장권',1,'2025-12-17 07:49:16','2026-01-16 05:56:47',NULL,1,1,1),(14,7,7,NULL,3,'2026-03-14 14:00:00',NULL,NULL,'7열',2,0,2,180000,'VIP석 2연석입니다. 시야 최고!',1,'2025-12-18 04:03:13','2026-01-16 05:56:47',NULL,1,1,1),(15,8,7,NULL,3,'2026-03-14 14:00:00',NULL,NULL,'10열',1,0,1,130000,'R석 단석입니다.',1,'2025-12-18 04:03:13','2026-01-16 05:56:47',NULL,1,1,1),(16,9,8,NULL,3,'2026-04-23 19:30:00',NULL,NULL,'11열',2,0,2,90000,'조승우 캐스팅일입니다!',1,'2025-12-18 04:03:13','2026-01-16 05:56:47',NULL,1,1,1),(17,10,8,NULL,3,'2026-04-24 14:00:00',NULL,NULL,'6열',1,0,1,200000,'정중앙 최고의 시야',1,'2025-12-18 04:03:13','2026-01-16 05:56:47',NULL,1,1,1),(18,7,9,NULL,3,'2026-05-28 19:00:00',NULL,NULL,'13열',2,0,2,150000,'김준수 캐스팅, 연석',1,'2025-12-18 04:03:13','2026-01-16 05:56:47',NULL,1,1,1),(19,8,10,NULL,3,'2026-07-03 19:00:00',NULL,NULL,'9열',1,0,1,80000,'2층 맨 앞줄 시야 좋아요',1,'2025-12-18 04:03:13','2026-01-16 05:56:47',NULL,1,1,1),(20,10,11,NULL,2,'2026-04-18 14:00:00',NULL,NULL,'7열',2,0,2,25000,'야구 관람 좋은 자리입니다',1,'2025-12-18 04:03:31','2026-01-16 05:56:47',NULL,1,1,1),(21,7,11,NULL,2,'2026-04-18 14:00:00',NULL,NULL,'4열',4,0,4,12000,'외야 응원석 4장 함께 드려요',1,'2025-12-18 04:03:31','2026-01-16 05:56:47',NULL,1,1,1),(22,8,12,NULL,2,'2026-04-25 18:30:00',NULL,NULL,'19열',2,0,2,50000,'테이블석 연석, 맥주 마시며 관람',1,'2025-12-18 04:03:31','2026-01-16 05:56:47',NULL,1,1,1),(23,9,13,NULL,2,'2026-05-23 19:00:00',NULL,NULL,'5열',2,0,2,35000,'축구 경기 좋은 시야',1,'2025-12-18 04:03:31','2026-01-16 05:56:47',NULL,1,1,1),(24,11,13,NULL,2,'2026-05-23 19:00:00',NULL,NULL,'4열',1,0,1,20000,'가성비 좋은 자리',1,'2025-12-18 04:03:31','2026-01-16 05:56:47',NULL,1,1,1),(25,10,14,NULL,2,'2026-11-28 18:00:00',NULL,NULL,'7열',2,0,2,150000,'코트 바로 옆! 선수들 코앞에서!',1,'2025-12-18 04:03:31','2026-01-16 05:56:47',NULL,1,1,1),(26,7,15,NULL,2,'2026-06-18 20:00:00',NULL,NULL,'2열',2,0,2,80000,'손흥민 볼 수 있어요!',1,'2025-12-18 04:03:31','2026-01-16 05:56:47',NULL,1,1,1),(27,7,16,NULL,4,'2026-03-28 14:00:00',NULL,NULL,'10열',2,0,2,18000,'제주 빛의 시어터 반 고흐 전시 입장권입니다',1,'2025-12-18 04:03:48','2026-01-16 05:56:47',NULL,1,1,1),(28,8,17,NULL,4,'2026-05-14 15:00:00',NULL,NULL,'2열',1,0,1,25000,'디지털 아트 전시 입장권',1,'2025-12-18 04:03:48','2026-01-16 05:56:47',NULL,1,1,1),(29,9,18,NULL,4,'2026-06-02 11:00:00',NULL,NULL,'2열',2,0,2,16000,'모네 특별전 입장권 2매',1,'2025-12-18 04:03:48','2026-01-16 05:56:47',NULL,1,1,1),(30,10,1,NULL,4,'2026-06-14 10:00:00',NULL,NULL,'20열',2,0,2,45000,'에버랜드 1일 자유이용권입니다',1,'2025-12-18 04:03:48','2026-01-16 05:56:47',NULL,1,1,1),(31,11,1,NULL,4,'2026-07-28 10:00:00',NULL,NULL,'16열',1,0,1,40000,'롯데월드 1일권 판매합니다',1,'2025-12-18 04:03:48','2026-01-16 05:56:47',NULL,1,1,1),(32,7,1,NULL,4,'2026-08-23 10:00:00',NULL,NULL,'19열',3,0,3,35000,'여름 캐리비안베이 3장 일괄',1,'2025-12-18 04:03:48','2026-01-16 05:56:47',NULL,1,1,1),(33,8,1,NULL,4,'2027-01-13 23:59:59',NULL,NULL,'6열',5,0,5,10000,'CGV 영화 관람권 5장',1,'2025-12-18 04:03:48','2026-01-16 05:56:47',NULL,1,1,1),(34,12,1,'SCH001',1,'2026-01-28 19:00:00',NULL,NULL,'2열',2,1,2,5000,'테스트',1,'2026-01-15 00:56:14','2026-01-16 05:56:47',NULL,1,1,1),(35,12,1,'SCH001',1,'2026-01-28 19:00:00',NULL,NULL,'11열',2,1,2,60000,'티켓 어쩌고 저쩌고 테스트 하는 중',1,'2026-01-16 03:49:15','2026-01-16 05:56:47',NULL,1,1,1);
...
-- Dump completed on 2026-01-19  9:10:49
