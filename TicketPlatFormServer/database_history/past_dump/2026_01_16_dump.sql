...
) ENGINE=InnoDB AUTO_INCREMENT=138 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='Refresh Token 저장 테이블';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `seat_grades` (
  `id` int NOT NULL AUTO_INCREMENT,
  `code` varchar(50) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '좌석 등급 코드',
  `name_ko` varchar(50) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '한글명',
  `name_en` varchar(50) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '영문명',
...
INSERT INTO `seat_grades` VALUES (1,'vip','VIP','VIP',1,'2026-01-16 04:49:49','2026-01-16 04:49:49'),(2,'general','일반','General',2,'2026-01-16 04:49:49','2026-01-16 04:49:49'),(3,'reserved','지정석','Reserved',3,'2026-01-16 04:49:49','2026-01-16 04:49:49'),(4,'standing','입장권','Standing',4,'2026-01-16 04:49:49','2026-01-16 04:49:49');
/*!40000 ALTER TABLE `seat_grades` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `seat_locations`
--
...
--
-- Dumping data for table `seat_locations`
--

LOCK TABLES `seat_locations` WRITE;
/*!40000 ALTER TABLE `seat_locations` DISABLE KEYS */;
INSERT INTO `seat_locations` VALUES ('LOC_1F',NULL,'1층',1,1),('LOC_2F',NULL,'2층',1,2),('LOC_STANDING',NULL,'스탠딩',1,3),('LOC_VIP',NULL,'VIP석',1,4);
/*!40000 ALTER TABLE `seat_locations` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `ticket_features` (
  `id` int NOT NULL AUTO_INCREMENT,
  `code` varchar(50) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '특이사항 코드',
  `name_ko` varchar(100) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '한글명',
  `name_en` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '영문명',
  `description` text COLLATE utf8mb4_unicode_ci COMMENT '설명',
  `icon` varchar(50) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '아이콘 (UI용)',
  `sort_order` int DEFAULT '0' COMMENT '정렬 순서',
  `created_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP,
  `updated_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
  UNIQUE KEY `code` (`code`)
) ENGINE=InnoDB AUTO_INCREMENT=8 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='티켓 특이사항 마스터';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `ticket_features` VALUES (1,'reservation_id','예매처 ID로 전달','Transfer via Reservation ID','예매처 ID로 티켓을 전달합니다',NULL,1,'2026-01-16 04:49:58','2026-01-16 04:49:58'),(2,'on_site_pickup','현장발권','On-site Pickup','현장에서 직접 발권 가능합니다',NULL,2,'2026-01-16 04:49:58','2026-01-16 04:49:58'),(3,'mobile_ticket','모바일티켓','Mobile Ticket','모바일로 입장 가능합니다',NULL,3,'2026-01-16 04:49:58','2026-01-16 04:49:58'),(4,'discount_ticket','할인티켓(증빙필요)','Discount Ticket (Proof Required)','할인티켓으로 증빙 서류가 필요합니다',NULL,4,'2026-01-16 04:49:58','2026-01-16 04:49:58'),(5,'id_required','신분증필요','ID Required','입장 시 신분증이 필요합니다',NULL,5,'2026-01-16 04:49:58','2026-01-16 04:49:58'),(6,'restricted_view','시야제한석','Restricted View','시야가 제한될 수 있습니다',NULL,6,'2026-01-16 04:49:58','2026-01-16 04:49:58'),(7,'on_site_help','현장도움','On-site Assistance','현장에서 직원의 도움이 필요합니다',NULL,7,'2026-01-16 04:49:58','2026-01-16 04:49:58');
...
--
-- Table structure for table `ticket_ticket_features`
--

DROP TABLE IF EXISTS `ticket_ticket_features`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `ticket_ticket_features` (
  `id` int NOT NULL AUTO_INCREMENT,
  `ticket_id` int NOT NULL COMMENT '티켓 ID',
  `feature_id` int NOT NULL COMMENT '특이사항 ID',
  `created_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
  UNIQUE KEY `uk_ticket_feature` (`ticket_id`,`feature_id`),
  KEY `idx_feature_id` (`feature_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='티켓-특이사항 연결 테이블';
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `ticket_ticket_features`
--

LOCK TABLES `ticket_ticket_features` WRITE;
/*!40000 ALTER TABLE `ticket_ticket_features` DISABLE KEYS */;
/*!40000 ALTER TABLE `ticket_ticket_features` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `tickets` (
  ...
  CONSTRAINT `fk_tickets_seat_grade` FOREIGN KEY (`seat_grade_id`) REFERENCES `seat_grades` (`id`) ON DELETE SET NULL,
  ...
  CONSTRAINT `chk_ticket_price_valid` CHECK ((`price` <= `original_price`)),
...
) ENGINE=InnoDB AUTO_INCREMENT=36 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='티켓 정보 테이블';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `tickets` VALUES (1,7,1,NULL,1,'2026-01-28 19:00:00',NULL,'B구역','19열',2,0,2,220000,250000,'VIP석 연석 2장',1,'2025-12-17 07:49:16','2026-01-16 05:56:47',NULL,1,1,1),(2,7,1,NULL,1,'2026-01-28 19:00:00',NULL,'C구역','3열',1,0,1,150000,180000,'R석 1장',1,'2025-12-17 07:49:16','2026-01-16 05:56:47',NULL,1,1,1),(3,7,1,NULL,1,'2026-01-28 19:00:00',NULL,'D구역','20열',3,0,1,99000,130000,'S석',1,'2025-12-17 07:49:16','2026-01-16 05:56:47',NULL,1,1,1),(4,7,1,NULL,1,'2026-01-29 19:00:00',NULL,'A구역','11열',2,0,0,230000,250000,'VIP석 연석 2장 (매진임박)',1,'2025-12-17 07:49:16','2026-01-16 05:56:47',NULL,1,1,1),(5,7,1,NULL,1,'2026-01-29 19:00:00',NULL,'B구역','14열',4,0,2,160000,180000,'R석',1,'2025-12-17 07:49:16','2026-01-16 05:56:47',NULL,1,1,1),(6,7,2,NULL,1,'2026-02-23 18:00:00',NULL,'C구역','15열',10,0,8,180000,200000,'VIP 입장권',1,'2025-12-17 07:49:16','2026-01-16 05:56:47',NULL,1,1,1),(7,7,2,NULL,1,'2026-02-23 18:00:00',NULL,'D구역','14열',30,0,25,99000,120000,'일반 입장권',1,'2025-12-17 07:49:16','2026-01-16 05:56:47',NULL,1,1,1),(8,7,2,NULL,1,'2026-02-24 18:00:00',NULL,'A구역','5열',20,0,12,99000,120000,'일반 입장권',1,'2025-12-17 07:49:16','2026-01-16 05:56:47',NULL,1,1,1),(9,7,3,NULL,1,'2026-08-02 17:00:00',NULL,'B구역','4열',50,0,30,132000,150000,'스탠딩 입장권',1,'2025-12-17 07:49:16','2026-01-16 05:56:47',NULL,1,1,1),(10,7,3,NULL,1,'2026-08-02 17:00:00',NULL,'C구역','2열',20,0,2,165000,180000,'지정석 입장권 (인기)',1,'2025-12-17 07:49:16','2026-01-16 05:56:47',NULL,1,1,1),(11,7,3,NULL,1,'2026-08-03 17:00:00',NULL,'D구역','20열',50,0,50,132000,150000,'스탠딩 입장권',1,'2025-12-17 07:49:16','2026-01-16 05:56:47',NULL,1,1,1),(12,7,4,NULL,1,'2026-03-14 18:00:00',NULL,'A구역','12열',10,0,5,250000,280000,'VIP석 (티켓 5장 남음)',1,'2025-12-17 07:49:16','2026-01-16 05:56:47',NULL,1,1,1),(13,7,6,NULL,1,'2026-10-28 19:00:00',NULL,'B구역','1열',100,0,20,180000,200000,'스탠딩 입장권',1,'2025-12-17 07:49:16','2026-01-16 05:56:47',NULL,1,1,1),(14,7,7,NULL,3,'2026-03-14 14:00:00',NULL,'C구역','7열',2,0,2,180000,198000,'VIP석 2연석입니다. 시야 최고!',1,'2025-12-18 04:03:13','2026-01-16 05:56:47',NULL,1,1,1),(15,8,7,NULL,3,'2026-03-14 14:00:00',NULL,'D구역','10열',1,0,1,130000,154000,'R석 단석입니다.',1,'2025-12-18 04:03:13','2026-01-16 05:56:47',NULL,1,1,1),(16,9,8,NULL,3,'2026-04-23 19:30:00',NULL,'A구역','11열',2,0,2,90000,110000,'조승우 캐스팅일입니다!',1,'2025-12-18 04:03:13','2026-01-16 05:56:47',NULL,1,1,1),(17,10,8,NULL,3,'2026-04-24 14:00:00',NULL,'B구역','6열',1,0,1,200000,220000,'정중앙 최고의 시야',1,'2025-12-18 04:03:13','2026-01-16 05:56:47',NULL,1,1,1),(18,7,9,NULL,3,'2026-05-28 19:00:00',NULL,'C구역','13열',2,0,2,150000,176000,'김준수 캐스팅, 연석',1,'2025-12-18 04:03:13','2026-01-16 05:56:47',NULL,1,1,1),(19,8,10,NULL,3,'2026-07-03 19:00:00',NULL,'D구역','9열',1,0,1,80000,99000,'2층 맨 앞줄 시야 좋아요',1,'2025-12-18 04:03:13','2026-01-16 05:56:47',NULL,1,1,1),(20,10,11,NULL,2,'2026-04-18 14:00:00',NULL,'A구역','7열',2,0,2,25000,30000,'야구 관람 좋은 자리입니다',1,'2025-12-18 04:03:31','2026-01-16 05:56:47',NULL,1,1,1),(21,7,11,NULL,2,'2026-04-18 14:00:00',NULL,'B구역','4열',4,0,4,12000,15000,'외야 응원석 4장 함께 드려요',1,'2025-12-18 04:03:31','2026-01-16 05:56:47',NULL,1,1,1),(22,8,12,NULL,2,'2026-04-25 18:30:00',NULL,'C구역','19열',2,0,2,50000,60000,'테이블석 연석, 맥주 마시며 관람',1,'2025-12-18 04:03:31','2026-01-16 05:56:47',NULL,1,1,1),(23,9,13,NULL,2,'2026-05-23 19:00:00',NULL,'D구역','5열',2,0,2,35000,40000,'축구 경기 좋은 시야',1,'2025-12-18 04:03:31','2026-01-16 05:56:47',NULL,1,1,1),(24,11,13,NULL,2,'2026-05-23 19:00:00',NULL,'A구역','4열',1,0,1,20000,25000,'가성비 좋은 자리',1,'2025-12-18 04:03:31','2026-01-16 05:56:47',NULL,1,1,1),(25,10,14,NULL,2,'2026-11-28 18:00:00',NULL,'B구역','7열',2,0,2,150000,180000,'코트 바로 옆! 선수들 코앞에서!',1,'2025-12-18 04:03:31','2026-01-16 05:56:47',NULL,1,1,1),(26,7,15,NULL,2,'2026-06-18 20:00:00',NULL,'C구역','2열',2,0,2,80000,100000,'손흥민 볼 수 있어요!',1,'2025-12-18 04:03:31','2026-01-16 05:56:47',NULL,1,1,1),(27,7,16,NULL,4,'2026-03-28 14:00:00',NULL,'D구역','10열',2,0,2,18000,22000,'제주 빛의 시어터 반 고흐 전시 입장권입니다',1,'2025-12-18 04:03:48','2026-01-16 05:56:47',NULL,1,1,1),(28,8,17,NULL,4,'2026-05-14 15:00:00',NULL,'A구역','2열',1,0,1,25000,30000,'디지털 아트 전시 입장권',1,'2025-12-18 04:03:48','2026-01-16 05:56:47',NULL,1,1,1),(29,9,18,NULL,4,'2026-06-02 11:00:00',NULL,'B구역','2열',2,0,2,16000,20000,'모네 특별전 입장권 2매',1,'2025-12-18 04:03:48','2026-01-16 05:56:47',NULL,1,1,1),(30,10,1,NULL,4,'2026-06-14 10:00:00',NULL,'C구역','20열',2,0,2,45000,58000,'에버랜드 1일 자유이용권입니다',1,'2025-12-18 04:03:48','2026-01-16 05:56:47',NULL,1,1,1),(31,11,1,NULL,4,'2026-07-28 10:00:00',NULL,'D구역','16열',1,0,1,40000,52000,'롯데월드 1일권 판매합니다',1,'2025-12-18 04:03:48','2026-01-16 05:56:47',NULL,1,1,1),(32,7,1,NULL,4,'2026-08-23 10:00:00',NULL,'A구역','19열',3,0,3,35000,45000,'여름 캐리비안베이 3장 일괄',1,'2025-12-18 04:03:48','2026-01-16 05:56:47',NULL,1,1,1),(33,8,1,NULL,4,'2027-01-13 23:59:59',NULL,'B구역','6열',5,0,5,10000,14000,'CGV 영화 관람권 5장',1,'2025-12-18 04:03:48','2026-01-16 05:56:47',NULL,1,1,1),(34,12,1,'SCH001',1,'2026-01-28 19:00:00','LOC_1F','a구역','2열',2,1,2,5000,5000,'테스트',1,'2026-01-15 00:56:14','2026-01-16 05:56:47',NULL,1,1,1),(35,12,1,'SCH001',1,'2026-01-28 19:00:00','LOC_1F','D구역','11열',2,1,2,60000,60000,'티켓 어쩌고 저쩌고 테스트 하는 중',1,'2026-01-16 03:49:15','2026-01-16 05:56:47',NULL,1,1,1);
...
CREATE TABLE `trade_methods` (
  `id` int NOT NULL AUTO_INCREMENT,
  `code` varchar(50) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '거래 방식 코드',
  `name_ko` varchar(50) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '한글명',
  `name_en` varchar(50) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '영문명',
  `description` text COLLATE utf8mb4_unicode_ci COMMENT '설명',
  `sort_order` int DEFAULT '0' COMMENT '정렬 순서',
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `code` (`code`)
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='거래 방식 마스터';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `trade_methods` VALUES (1,'pin_trade','PIN거래','PIN Trade','예매 PIN 번호를 전달하는 방식입니다',1,'2026-01-16 04:50:05','2026-01-16 04:50:05'),(2,'delivery','배송거래','Delivery','실물 티켓을 배송하는 방식입니다',2,'2026-01-16 04:50:05','2026-01-16 04:50:05'),(3,'on_site','현장거래','On-site Trade','현장에서 직접 만나 거래하는 방식입니다',3,'2026-01-16 04:50:05','2026-01-16 04:50:05'),(4,'other','기타거래','Other','기타 방식의 거래입니다',4,'2026-01-16 04:50:05','2026-01-16 04:50:05');
...
-- Dump completed on 2026-01-16 17:10:01
