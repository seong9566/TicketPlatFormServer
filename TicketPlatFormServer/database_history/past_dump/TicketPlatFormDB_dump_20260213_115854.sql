...
) ENGINE=InnoDB AUTO_INCREMENT=230 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='채팅 메시지 테이블';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=43 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='채팅방 테이블';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=8 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='에스크로 (결제 대금 보관) 테이블';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='알림 디바이스 토큰 테이블';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `notification_token` VALUES (2,12,'d02NFsgiQBKRuhTSXZSHmr:APA91bE86VWAVlCp6g2lbVS4t4Q2tiAiFmgFUyz8DjZXaKhr83OmAj5HcF-KN8IZq7yaGJGW37FChM7HHrsRkqzKQwdzM3K34D5OQ-pGsBCCHk_Fs5AJtNk',1,'2026-02-11 13:59:23');
...
INSERT INTO `notification_types` VALUES (1,'CHAT_MESSAGE','채팅 메시지',1,1),(2,'PAYMENT_REQUEST','결제 요청',1,2),(3,'PAYMENT_SUCCESS','결제 완료',1,3),(4,'PURCHASE_CONFIRMED','구매 확정',1,4),(5,'DISPUTE_OPENED','신고 접수',1,5),(6,'DISPUTE_RESOLVED','신고 해결',1,6);
...
) ENGINE=InnoDB AUTO_INCREMENT=58 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='알림 테이블';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='카드 결제 상세 정보 (PCI DSS 주의: 마스킹된 정보만 저장)';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `payment_card_details` VALUES (1,12,'UNKNOWN','53275011****425*',0,'00000000','신용','개인','READY',0,'24','21',NULL,0,450000,'2026-02-11 22:03:37','2026-02-12 07:03:37');
...
) ENGINE=InnoDB AUTO_INCREMENT=9 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='결제 거래 히스토리 (승인/취소/부분취소 모든 이벤트 추적)';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=13 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='결제 정보 테이블';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=600 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='Refresh Token 저장 테이블';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `settlement_statuses` VALUES (1001,'pending','정산 대기',1,1),(1002,'processing','정산 처리중',1,2),(1003,'completed','정산 완료',1,3),(1004,'failed','정산 실패',1,4);
...
) ENGINE=InnoDB AUTO_INCREMENT=25 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='티켓 정보 테이블';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=18 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='거래 항목 테이블 (티켓별 구매 정보)';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `transaction_items` VALUES (13,13,23,3,36000,108000,'2026-02-11 17:34:09'),(14,14,23,2,180000,360000,'2026-02-11 18:53:13'),(15,15,24,1,150000,150000,'2026-02-11 18:57:24'),(16,16,24,3,150000,450000,'2026-02-11 19:12:32'),(17,17,24,3,150000,450000,'2026-02-11 21:00:53');
...
) ENGINE=InnoDB AUTO_INCREMENT=18 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='거래 정보 테이블 (하나의 거래에 여러 티켓 항목 가능)';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=41 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='사용자 찜 테이블';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `user_favorites` VALUES (1,7,1,1,'2025-12-18 02:05:53'),(2,7,1,2,'2025-12-18 02:05:53'),(3,8,1,1,'2025-12-18 02:05:53'),(4,8,1,6,'2025-12-18 02:05:53'),(5,9,1,4,'2025-12-18 02:05:53'),(6,10,1,5,'2025-12-18 02:05:53'),(38,12,2,18,'2026-02-12 23:37:54'),(39,12,2,8,'2026-02-12 23:48:23'),(40,12,2,3,'2026-02-12 23:48:45');
...
) ENGINE=InnoDB AUTO_INCREMENT=24 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='사용자 기본 정보 테이블';
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2026-02-13 11:58:54
