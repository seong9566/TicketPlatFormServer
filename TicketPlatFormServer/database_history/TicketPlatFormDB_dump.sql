...
SET @@GLOBAL.GTID_PURGED=/*!80000 '+'*/ '811ccd2c-62c8-11f0-9312-1a182a883054:1-225,
...
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='사용자 은행 계좌 정보 테이블';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `notification_token` VALUES (4,12,'d02NFsgiQBKRuhTSXZSHmr:APA91bE86VWAVlCp6g2lbVS4t4Q2tiAiFmgFUyz8DjZXaKhr83OmAj5HcF-KN8IZq7yaGJGW37FChM7HHrsRkqzKQwdzM3K34D5OQ-pGsBCCHk_Fs5AJtNk',1,'2026-02-24 19:14:20');
...
INSERT INTO `notification_types` VALUES (1,'CHAT_MESSAGE','채팅 메시지',1,1),(2,'PAYMENT_REQUEST','결제 요청',1,2),(3,'PAYMENT_SUCCESS','결제 완료',1,3),(4,'PURCHASE_CONFIRMED','구매 확정',1,4),(5,'DISPUTE_OPENED','신고 접수',1,5),(6,'DISPUTE_RESOLVED','신고 해결',1,6),(7,'REVIEW_REQUEST','리뷰 요청',1,7);
...
) ENGINE=InnoDB AUTO_INCREMENT=707 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='Refresh Token 저장 테이블';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='정산 정보 테이블';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=47 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='티켓 정보 테이블';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=28 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='사용자 기본 정보 테이블';
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2026-02-25 17:19:58
