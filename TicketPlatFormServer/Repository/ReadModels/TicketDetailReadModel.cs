...
/// <summary>
/// 티켓 상세 조회 ReadModel (Repository 반환용)
/// </summary>
public class TicketDetailReadModel
{
    ...
    /// 이벤트 정보
    /// </summary>
    public EventInfoReadModel Event { get; set; } = null!;
}

/// <summary>
/// 이벤트 정보 ReadModel (티켓 상세 조회용)
/// </summary>
public class EventInfoReadModel
{
